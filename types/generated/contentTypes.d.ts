...
export interface ApiHcgsDevisListHcgsDevisList
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    CodePostal: Schema.Attribute.Integer &
      Schema.Attribute.Required &
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::hcgs-devis-list.hcgs-devis-list'
    > &
      Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    Rue: Schema.Attribute.String & Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::hcgs-devis-list.hcgs-devis-list': ApiHcgsDevisListHcgsDevisList;
